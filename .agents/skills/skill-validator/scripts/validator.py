...
class SkillValidator:
    ...
    def validate_all(self, run_evals: bool = True, verbose: bool = False) -> Dict[str, Any]:
    ...
    def _validate_structure(self) -> ValidationCheck:
        ...
        try:
            ...
            return ValidationCheck(
                ...
                errors=[] if passed else [result.stderr or result.stdout or "Validation failed"],
                warnings=[]
            )
        ...
        try:
            ...
            try:
                ...
                return ValidationCheck(
                    ...
                    passed=passed,
                    details=data,
                    errors=[] if passed else [f"Found {data.get('summary', {}).get('critical', 0)} critical issues"],
                    warnings=[]
                )
        ...
        try:
            ...
            try:
                ...
                return ValidationCheck(
                    ...
                    passed=passed,
                    details=data,
                    errors=[] if passed else [f"Trigger rate {trigger_rate} below threshold"],
                    warnings=[]
                )
            except (FileNotFoundError, json.JSONDecodeError):
                return None
    ...
    def _aggregate_results(self, skill_name: str, include_evals: bool) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'validation_types': {
                'structure': any(c.type == ValidationType.STRUCTURE.value for c in self.checks),
                'security': any(c.type == ValidationType.SECURITY.value for c in self.checks),
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Comprehensive skill validator"
    )
