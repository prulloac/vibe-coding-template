...
def generate_lateral_thinking_ideas(topic: str, context: str = "") -> List[Idea]:
    ...
    random_concepts = [
        "ocean waves", "chess game", "garden", "jazz music", "mirror",
        "library", "storm", "river", "marketplace", "telescope",
        "beehive", "clock", "volcano", "forest", "bridge"
    ]
...
def generate_forced_connections_ideas(topic: str, context: str = "") -> List[Idea]:
    ...
    external_domains = [
        "e-commerce platforms", "healthcare systems", "aerospace engineering",
        "sports coaching", "film production", "urban planning",
        "culinary arts", "game design", "education systems", "natural ecosystems"
    ]
...
def main():
    ...
    parser.add_argument(
        "topic",
        help="The brainstorming topic or challenge"
    )
    parser.add_argument(
        "--context",
        default="",
